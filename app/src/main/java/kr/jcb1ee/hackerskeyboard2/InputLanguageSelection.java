...
public class InputLanguageSelection extends AppCompatActivity {
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat {
        ...
        private boolean hasDictionary(Locale locale) {
            ...
            BinaryDictionary bd = new BinaryDictionary(requireContext(), dictionaries, Suggest.DIC_MAIN);
            ...
            if (bd.getSize() > Suggest.LARGE_DICTIONARY_THRESHOLD / 4) {
                ...
                BinaryDictionary plug = PluginManager.getDictionary(requireContext().getApplicationContext(), locale.getLanguage());
                if (plug != null) {
                    bd.close();
                    bd = plug;
                    haveDictionary = true;
